...
This project is an AI-powered document intelligence platform built to ingest, understand, and deliver actionable insights from various documents.
...
- 🗄️ **Persistent Knowledge Base**: Documents are processed and stored in a searchable vector database using FAISS.
...
1.  **Clone the Repository**
    ...
    ```bash
    git clone https://github.com/BhanuPrakash-004/KnowledgeBase.git
    cd backend-python
    ```
